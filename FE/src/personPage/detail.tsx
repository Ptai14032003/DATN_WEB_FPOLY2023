...
export default function Detail() {
    ...
    return (
        <div className="container-detail text-white bg-black">
            <div className="">
                <div>
            ...
            <div className="w-[90%] mx-auto bg-white text-black px-[25px] py-[15px]">
                ...
                {/* <div className={`flex gap-10  ${checkPhanHoi === 0 ? "" : `${checkPhanHoi === 2 ? "pb-[90px]" : ``}`}`}>
                    <div><img src="/avata.jpg" alt="" width={56} height={48} /></div>
                    <div className={`w-[75%] h-[85px] `}>
                        <div className="text-[#4267b2] font-bold">Đinh Tài</div>
                        <div className="">Cuốn vc :)))</div>
                        <div className="flex gap-2 text-[12px] text-blue-500 mt-2">
                            <div className="btn-comment hover:cursor-pointer">Thích</div>
                            <div>-</div>
                            <div className="btn-comment hover:cursor-pointer" onClick={() => setPhanHoi(2)}>Phản hồi</div>
                            <div>-</div>
                            <div className="text-slate-400">4 ngày</div>
                        </div>
                        <div className={`border-l-[1px] pl-[10px] ${checkPhanHoi === 2 ? "" : "hidden"}`}>
                            <div className="flex gap-2 rounded mt-[10px] ">
                                <div><img src="/avata.jpg" alt="" width={36} height={36} /></div>
                                <div className={`w-[75%] h-[90px] relative bg-[#f5f6f7]`}>
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <input type="text" className="w-[100%] h-[50px] outline-none border-[2px] pl-2 placeholder:text-gray-500 text-[15px] " {...register("comment")} placeholder="Viết bình luận ....." autoComplete="false" />
                                        <div className={`bg-transparent w-[60px] my-[6px] absolute right-[120px] text-center rounded border-[2px]`}>
                                            <div className="bg-transparent mx-[10px] text-slate-500" onClick={() => closeComment()}>Huỷ</div>
                                        </div>
                                        <div className={`bg-blue-600 w-[80px] my-[6px] absolute right-5 text-center rounded border-[1px]`}>
                                            <button type="submit" className=" bg-transparent mx-[10px] text-white" onClick={() => setPhanHoi(0)}>Trả lời</button>
                                        </div>
                                    </form>
                                    {errors.comment && <p className="text-red-500 pl-[10px] pt-2">{errors.comment?.message}</p>}
                                </div>
                            </div>
                ...
                {/* <div className={`flex gap-10  ${checkPhanHoi === 0 ? "" : `${checkPhanHoi === 3 ? "pb-[90px]" : ``}`}`}>
                    <div><img src="/avata.jpg" alt="" width={56} height={48} /></div>
                    <div className={`w-[75%] h-[85px] `}>
                        <div className="text-[#4267b2] font-bold">Đinh Tài</div>
                        <div className="">Cuốn vc :)))</div>
                        <div className="flex gap-2 text-[12px] text-blue-500 mt-2">
                            <div className="btn-comment hover:cursor-pointer">Thích</div>
                            <div>-</div>
                            <div className="btn-comment hover:cursor-pointer" onClick={() => setPhanHoi(3)}>Phản hồi</div>
                            <div>-</div>
                            <div className="text-slate-400">4 ngày</div>
                        </div>
                        <div className={`border-l-[1px] pl-[10px] ${checkPhanHoi === 3 ? "" : "hidden"}`}>
                            <div className="flex gap-4 rounded mt-[10px] ">
                                <div><img src="/avata.jpg" alt="" width={36} height={36} /></div>
                                <div className={`w-[75%] h-[90px] relative bg-[#f5f6f7]`}>
                                    <input type="text" name="" id="" className="w-[100%] h-[50px] outline-none border-[2px] pl-2 placeholder:text-gray-500 text-[15px] " placeholder="Viết bình luận ....." autoComplete="false" />
                                    <div className={`bg-transparent w-[60px] my-[6px] absolute right-[120px] text-center rounded border-[2px]`}>
                                        <button type="submit" className="bg-transparent mx-[10px] text-slate-500" onClick={() => setPhanHoi(0)}>Huỷ</button>
                                    </div>
                                    <div className={`bg-blue-600 w-[80px] my-[6px] absolute right-5 text-center rounded border-[1px]`}>
                                        <button type="submit" className=" bg-transparent mx-[10px] text-white" onSubmit={() => postComment()}>Trả lời</button>
                                    </div>
