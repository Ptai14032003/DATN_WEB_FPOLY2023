...
const TicketPrice = (props: Props) => {
    return (
        <div className='ticket-price bg-black h-full'>
            ...
            <div className='ticket-price-content mb-14'>
