...
export const { useFetchSeatRoomIdQuery, useTicketHistoryMutation, useListBillMutation, useGetBillIdMutation, useExportBillMutation, useSumbitQRPaymentMutation } = bookingApi
